              ...
              <div class="card">
                <div class="card-body">
                    ...
                    include '../conn.php';
                        ...
                        $select = "SELECT * FROM `deptclerk` WHERE dc_id=$id";
                  ...
                  <form action="../update/dupdate.php?id=<?php echo $row['dc_id'];?>" method="post">
                    <div class="row g-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="cname" id="cname" class="form-select" required>
                                <option value="<?php echo $row['collegename']; ?>" disabled selected><?php echo $row['collegename']; ?></option>
                                <?php
