...
<div class="container bg-light p-3 rounded">
    ...
    <div id="st_2" class="col-md-12 text-center">
        ...
        <div class="col-md-6">
            <a class="btn btn-primary" href="../pages/course.php"><i class="fa fa-plus"></i> Add Course</a>
        </div>
        ...
        <table id="content" class="table table-responsive table-bordered">
            ...
            ?>
                <tr>
                    <td>
                    <a class="btn btn-danger" onclick="validation();" href="../delete/course.php?id=<?php echo $row['id'];?>"><i class="ti ti-trash"></i></a> &nbsp; <a class="btn btn-success" href="../edit/course.php?id=<?php echo $row['id'];?>"><i class="fa-solid fa-pen"></i></a>
                    </td>
                    <td>
                        <?php echo $row['id'];?>
                    </td>
